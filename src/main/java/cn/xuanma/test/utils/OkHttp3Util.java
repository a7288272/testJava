...
import cn.xuanma.common.utils.UrlUtil;
import cn.xuanma.common.utils.net.SSLSocketFactoryBuilder;
import cn.xuanma.common.utils.net.TrustAnyTrustManager;
 ...
 * Http请求工具类
 *
 * @author zhongquanliang 2018/06/19.
 */
public class OkHttp3Util {
     ...
     * @throws
     */
    public static String createHttpsPostByjson(String url, JSONObject postjson) {
        final StringBuilder buffer = new StringBuilder();
        /**忽略SSL协议证书*/
        OkHttpClient build = new OkHttpClient.Builder().build();
        MediaType mediaType = MediaType.parse("application/json;charset=UTF-8");
        final RequestBody requestBody = RequestBody.create(mediaType, postjson.toJSONString());
